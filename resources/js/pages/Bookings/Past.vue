        ...
        <div class="flex flex-col gap-6 p-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500">View and manage past restaurant bookings.</p>
                </div>
            ...
            <!-- Navigation -->
            <BookingNav current-path="/bookings/past" />
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="relative overflow-hidden rounded-xl border bg-white p-6 shadow-sm transition-all hover:shadow-md">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-600">Total Past</p>
                    ...
                    <Table>
                        ...
                        <TableBody>
                            ...
                            <TableRow v-if="bookings.length === 0">
                                <TableCell colspan="6" class="text-muted-foreground py-6 text-center"> No past bookings found </TableCell>
                            </TableRow>
                        </TableBody>
                    </Table>
                </div>
